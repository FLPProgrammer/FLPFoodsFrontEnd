⚡️O objetivo dessa aplicação foi entender como o React funciona na prática, desde a integração de componentes para formar uma página até a criação e uso de contextos. A ideia foi simular um modelo de restaurante e algumas de suas possíveis funcionalidades.
